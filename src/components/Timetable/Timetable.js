  ...
  return (
    <section className="timetable" id="plan">
      ...
      <div className="timetable__block">
        ...
        <p className="timetable__text timetable__text_about_rings">Welcome<br />15.00</p>
        <p className="timetable__text timetable__text_about_glasses">Церемония бракосочетания <br />15.30</p>
        <p className="timetable__text timetable__text_about_plate">Свадебный ужин <br /> 16.00</p>
        <p className="timetable__text timetable__text_about_cake">Свадебный торт <br /> 20.00</p>
        <p className="timetable__text timetable__text_about_music">Танцы <br /> 21.00</p>
